    ...
    body_omega_dot_filter(3, 3, 0.03) // LPF INIT
   {
    ...
    private:
      ...
      void numerical_calc_callback()
      {
        ...
        std::cout << "body_rpy_meas: " << body_rpy_meas.transpose() << std::endl;
        std::cout << "body_rpy_meas_prev: " << body_rpy_meas_prev.transpose() << std::endl;
        std::cout << "body_rpy_meas_dot_raw: " << body_rpy_meas_dot_raw.transpose() << std::endl;
        std::cout << "body_rpy_meas_dot: " << body_rpy_meas_dot.transpose() << std::endl;
      ...
      void data_publish()
      {
        ...
        global_EE_xyz_msg.data.push_back(body_omega_meas[0]);
        global_EE_xyz_msg.data.push_back(body_omega_meas[1]);
        global_EE_xyz_msg.data.push_back(body_rpy_meas_dot_raw[2]);
        ...
        global_EE_xyz_vel_msg.data.push_back(body_rpy_meas_dot[0]);
        global_EE_xyz_vel_msg.data.push_back(body_rpy_meas_dot[1]);
        global_EE_xyz_vel_msg.data.push_back(body_rpy_meas_dot[2]);
      ...
      void cf_pose_subscriber(const geometry_msgs::msg::PoseStamped::SharedPtr msg)
      {
          ...
          std::cout << "Yaw Continuous (rad): " << yaw_continuous << std::endl;
      }
